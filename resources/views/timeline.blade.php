          ...
          <div class="col-md-12">
            ...
            <div class="timeline">
              ...
              <div class="time-label">
                <span class="bg-gradient-secondary" name="tanggal">{{ $galeri->tanggal }}</span>
              </div>
              <!-- /.timeline-label -->
              <!-- timeline item -->
              <div>
                ...
                <div class="timeline-item">
                  <span class="time"><i class="fas fa-clock"></i> 9:15</span>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="model-footer">
                          <a href="{{ url('galeri/'.$galeri->id) }}" class="btn btn-primari">Hapus</a>
